...
FolderModel _folderModelDeserialize(
  ...
  final object = FolderModel(
    colorHex: reader.readStringOrNull(offsets[0]) ?? '#007AFF',
...
P _folderModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? '#007AFF') as P;
    case 1:
...
extension FolderModelQueryWhere
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> colorHexEqualTo(
      String colorHex) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterWhereClause> colorHexNotEqualTo(
      String colorHex) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension FolderModelQueryFilter
  ...
  QueryBuilder<FolderModel, FolderModel, QAfterFilterCondition> colorHexMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension FolderModelQueryProperty
  ...
  QueryBuilder<FolderModel, String, QQueryOperations> colorHexProperty() {
    return QueryBuilder.apply(this, (query) {
